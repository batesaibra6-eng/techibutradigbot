      ...
      <nav className="bg-white border-b sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="font-semibold">Mayuge Light • Student Portal</div>
          </div>
          
          <div className="flex items-center gap-4 text-sm">
            <div className="text-gray-600">Welcome, <span className="font-medium text-black">Nakato Sarah</span></div>
            <div className="w-8 h-8 bg-zinc-200 rounded-full overflow-hidden">
              <img src="/uploads/a level student girl.jpg" className="w-full h-full object-cover" alt="Profile" />
            </div>
        ...
        <div className="w-60 py-8 pr-8 hidden lg:block">
          <div className="space-y-1 text-sm">
            {[
              ...
              { label: "Examinations & Results", href: "/student/results" },
              { label: "Learning Resources", href: "/student/resources" },
